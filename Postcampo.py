...
def Postcampo(usuario,puesto):
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    #lote_2_municipios = {"Trinidad", "Iza", "Cuítiva"}#
      ...
      #lote_3 = '1'#
      # ----- Fin del script ---- #
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,distrito,tipo,lote,aprobados,rechazados,horas,manzana,sector,lotes,estado,area,efes,edificas,paquete,con_fmi,sin_fmi,observaciones,zona,tipo_calidad,horas_bi,area_bi,operador_cc,total_de_errores,errores_por_excepciones,tipo_de_errores,conteo_de_errores) VALUES('{marca_3}','{usuario}','{nombre_3}','{puesto}','{supervisor_3}','Postcampo','{fecha_3}','{semana_3}','{año_3}','{distrito_3}','{tipo_3}','{lotes_3}','0','0','{horas_3}','{manzana_3}','{sector_3}','0','{estado_3}','0.0','0','{edificas_3}','N/A','0','0','{observaciones_3}','N/A','N/A','{horas_bi}','0.0','N/A','0','0','N/A','0')")
    con.commit()                                                                                                                                 
