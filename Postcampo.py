...
def Postcampo(usuario,puesto):
  ...
  tipo_3= placeholder15_3.selectbox("Tipo", options=("Ordinario","Reproceso Ordinario","Corrección de Calidad","Corrección de Calidad Extraordinaria","Producción Horas Extras","Reproceso Horas Extras"), key="tipo_3")
