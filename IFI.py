...
def IFI(usuario,puesto):
  ...
  tipo_3= placeholder12_3.selectbox("Tipo", options=("Ordinario","Georreferenciación","Corrección Georreferenciación","Corrección Primera Revisión","Corrección Primera Reinspección"), key="tipo_3")
