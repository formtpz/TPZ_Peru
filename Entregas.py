...
def Entregas(usuario,puesto):
  ...
  tipo_de_errores_3= placeholder14_3.multiselect("Errores Entregas Postcampos", options=("Topológicos con apertura de manzana","Topológicos sin apertura de manzana","Alfanuméricos con apertura de manzana","Alfanuméricos sin apertura de manzana","Error de SICUN"), key="tipo_de_errores_3")
