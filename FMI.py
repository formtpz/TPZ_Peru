...
def FMI(usuario,puesto):
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,tipo,produccion,aprobados,rechazados,horas,uit,hito,lote,estado,area,efes,informales,partida,con_fmi,sin_fmi,observaciones,zona,tipo_calidad,horas_bi,area_bi,operador_cc,total_de_errores,errores_por_excepciones,tipo_de_errores,conteo_de_errores)VALUES('{marca_3}','{usuario}','{nombre_3}','{puesto}','{supervisor_3}','{proceso_3}','{fecha_3}','{semana_3}','{año_3}','{municipio_3}','{tipo_3}','{produccion_3}','0','0','0.0','{unidad_inter_3}','0','{lote_3}','{estado_3}','0.0','0','0','P0','0','{predios_sin_fmi_3}','{observaciones_3}','N/A','N/A','0','0','N/A','0','0','N/A','0')")
    con.commit()                                                                                                                                 
